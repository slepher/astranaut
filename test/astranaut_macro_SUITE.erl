...
init_per_suite(Config) ->
    TestModules = [
        ...
        macro_quote_context_example,
        macro_quote_context_test
    ],
...
test_pattern_case(_Config) ->
    ...
    ?assertEqual(
        {ok, {hello2, world, world, {hello, world}}},
...
test_quote_context_attribute_no_counter(_Config) ->
    Forms = [
        {attribute, 1, file, {"attr_no_counter_test.erl", 1}},
...
test_quote_context_no_double_counter(_Config) ->
    Forms = [
        {attribute, 1, file, {"no_double_counter_test.erl", 1}},
...
collect_var_names(Nodes) ->
    Collected =
        astranaut:reduce(
            fun
                ({var, _, Name}, Names) when is_atom(Name) ->
                    [Name | Names];
                (_Node, Names) ->
                    Names
            end,
