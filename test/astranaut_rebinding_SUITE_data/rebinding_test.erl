...
-rebinding_fun({[test_lc, test_bc, test_case], [debug]}).
...
-rebinding_fun({[test_lc_origin, test_bc_origin], no_rebinding}).
-rebinding_fun({[test_function_origin, test_case_origin], no_rebinding}).
