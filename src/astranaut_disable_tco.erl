...
walk_tail_expression(
    ...
    {function, CallerName, CallerArity},
    Variables,
    RecursiveGroups
) ->
...
walk_tail_expression(
    ...
    Operator =:= 'andalso'; Operator =:= 'orelse'
->
    {NRight, NVariables} =
        walk_tail_expression(
...
same_recursive_group(Caller, Callee, RecursiveGroups) ->
    case {maps:find(Caller, RecursiveGroups), maps:find(Callee, RecursiveGroups)} of
